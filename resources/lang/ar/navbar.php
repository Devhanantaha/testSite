...
return [
    ...
    "courses" => [
        ...
        "list_levels" => "عرض المراحل",
        "add_level" => "إضافه مرحلة",
        "add_course"  => "إضافة دوره",
        'recommend_courses' => 'دورات مرشحة',
    ...
    'faculities' => [
        'title' => 'عرض قائمة الكليات',
        'list' => 'عرض قائمة الكليات',
        'add' => 'إضافة كلية جديد',
    ],
    'teams' => [
        'list' => 'عرض فريق العمل',
    ...
    'finances' => [
        ...
        'instructor_profit_details' => 'تفاصيل أرباح المدرب'
    ...
    'instructors_side'=>[
        ...
        'paid_profits_requests' => 'سجل مدفوعات الارباح',
    ...
    'subjects' => [
        'list' => 'قائمة المواد',
        'add' => 'إضافة مادة',
        'first_class' => 'الصف الاول الثانوى',
        'second_class' => 'الصف الثانى الثانوى',
