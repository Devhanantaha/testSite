...
<div id="refauseModal-{{ $row->id }}" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
    <div class="modal-content">

      <form action="{{ url('admin/certification/changestatus')}}" method="post" class="delete-form">
        @csrf
        @method('POST')
        ...
        <div class="modal-body text-center py-4">
          ...
          <div class="text-secondary">
            {{ __('admin.refause_model_msg')}}
          </div>
          <input type="hidden" value="{{$row->id}}" name="id">
          <input type="hidden" value="0" name="status">
          <div class="mb-3">
            <label class="form-label">{{ __('admin.notes') }} <span class="form-label-description"></span></label>
            <!-- <input dir="auto" type="text" class="form-control" name="notes" rows="4" placeholder="Content.."> -->
