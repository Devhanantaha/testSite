  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="sidebar-menu">
      <ul class="navbar-nav pt-lg-3">
        <li class="nav-item   @if(request()->routeIs('instructor.dashboard.index')) active @endif ">
        ...
        <li class="nav-item  @if(request()->routeIs('instructor.quizzes')) active @endif">
          <a class="nav-link " href="{{ url('instructor/quizzes')}}">
            <span class="nav-link-icon d-md-none d-lg-inline-block">
              <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                <path d="M5 12l-2 0l9 -9l9 9l-2 0" />
        ...
        <li class="nav-item  @if(request()->routeIs('instructor.studentsexamresults')) active @endif">
          <a class="nav-link " href="{{ url('instructor/studentsexamresults')}}">
            <span class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/home -->
              <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                <path d="M5 12l-2 0l9 -9l9 9l-2 0" />
        ...
        <li class="nav-item  @if(request()->routeIs('instructor.requestProfit')) active @endif">
          <a class="nav-link " href="{{url('instructor/request-profit')}}">
            ...
            <span class="nav-link-title">
              {{ __('navbar.instructors_side.add_profits_requests') }}
            </span>
          </a>
        </li>
