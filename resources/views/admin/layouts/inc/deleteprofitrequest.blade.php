...
<div id="deleteprofit-{{ $row->id }}" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
        <div class="modal-content">
       
            <form action="{{ route('instructor.deleteRequest') }}" method="post" class="delete-form">
            @csrf
