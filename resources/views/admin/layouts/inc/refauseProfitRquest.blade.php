...
<div id="refauseRequestModal-{{ $row->id }}" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
    <div class="modal-content">

    <form action="{{ url('admin/profitrequest/changestatus')}}" method="post" class="delete-form">
    @csrf
        @method('POST')
        ...
        <div class="modal-body text-center py-4">
          ...
          <div class="text-secondary">
            {{ __('admin.refause_profit_request')}}
