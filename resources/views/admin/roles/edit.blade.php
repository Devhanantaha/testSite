        ...
        <div class="row row-cards">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <form class="needs-validation" action="{{ route($route.'.update', [$role->id]) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="card-body">
                            ...
                            <div class="form-group d-inline" style="margin-right: 40px;">
                                <div class="checkbox d-inline">
                                    ...
                                    @if(app()->getLocale() == 'en')
                                    <label class="" for="checkbox-{{ $value->id }}" class="cr">{{ $value->title_en }}</label>
