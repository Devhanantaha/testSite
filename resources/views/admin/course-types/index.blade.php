            ...
            <table class="export-table table card-table table-vcenter text-nowrap datatable" id="courseTypes">
              <thead>
                <tr>
                  ...
                  <th> {{__('admin.coursetypes.name_english')}}</th>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <div class="form-check form-switch md-3">
                      ...
                      <input data-id="{{$row->id}}" data-type='App\Models\CourseType' class="form-check-input form-control toggole-class" type="checkbox" role="switch" id="flexSwitchCheckDefault" @if($row->active==1) checked="checked" @endif name="active">
                    </div>
                  </td>
