          ...
          <div class="card-body">
            ...
            <div class="row">
              ...
              <div class="col-md-6 mb-3">
                ...
                <input type="text" class="form-control @error('question_ar') is-invalid @enderror" name="question_ar" id="question_ar" value="{{ old('question_ar', $row->question_ar) }}" required>
                @error('question_ar')
              ...
              <div class="col-md-6 mb-3">
                ...
                <input type="text" class="form-control @error('question_en') is-invalid @enderror" name="question_en" id="question_en" value="{{ old('question_en', $row->question_en) }}" required>
                @error('question_en')
                <div class="invalid-feedback">{{ $message }}</div>
                @enderror
              </div>
            ...
            <div class="row">
              ...
              <div class="col-md-6 mb-3">
                ...
                <textarea class="form-control @error('answer_ar') is-invalid @enderror" name="answer_ar" id="answer_ar" rows="6" required>{{ old('answer_ar', $row->answer_ar) }}</textarea>
                @error('answer_ar')
                <div class="invalid-feedback">{{ $message }}</div>
                @enderror
              </div>
              ...
              <div class="col-md-6 mb-3">
                ...
                <textarea class="form-control @error('answer_en') is-invalid @enderror" name="answer_en" id="answer_en" rows="6" required>{{ old('answer_en', $row->answer_en) }}</textarea>
                @error('answer_en')
                <div class="invalid-feedback">{{ $message }}</div>
                @enderror
              </div>
