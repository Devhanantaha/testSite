          ...
          <div class="card-body">
            <div class="row ">
              <div class="col-md-6">
                ...
                <div class="mb-3">
                  <label class="form-label" for="track_id">{{ __('admin.courses.sections') }} <span>*</span></label>
                ...
                <div class="mb-3">
                  <label class="form-label" for="track_id">{{ __('admin.courses.jobs') }} <span>*</span></label>
                      ...
                      <div class="card-body">
                        <div class="main">
                            ...
                            <label class="form-control">
                              ...
                              <span class="col-auto">
                                <label class="form-check form-check-single form-switch">
                                  <input class="form-check-input" type="checkbox" name="manual_review" id="manual_review">
                                </label>
                              </span>
                            </label>
                          </div>
                          ...
                          <div class="mb-3">
                            ...
                            <input type="number" max="5" class="form-control" name="manual_review_val" id="manual_review_val" value="{{ old('manual_review_val') }}" disabled>
                          ...
                          <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="google_link_measure_satisfaction" id="google_link_measure_satisfaction" value="{{ old('google_link_measure_satisfaction') }}">
                        ...
                        <div class="main">
                          <div class="md-3">
                            <label class="form-control">
                              ...
                              <span class="col-auto">
                                <label class="form-check form-check-single form-switch">
                                  <input class="form-check-input" type="checkbox" name="manual_review">
                                </label>
                              </span>
                            </label>
                          </div>
                          ...
                          <div class=" row mb-3" style="margin-top:10px;">
                              ...
                              <label class="form-control">
                                ...
                                <span class="col-auto">
                                  <label class="form-check form-check-single form-switch form-label">
                                    <input class="form-check-input form-control" type="checkbox" role="switch" id="flexSwitchCheckDefault" name="active">
                                  </label>
                                </span>
                              </label>
                            </div>
                            ...
                            <div class="col-md-12">
                              <label class="form-control form-label">
                                ...
                                <span class="col-auto">
                                  <label class="form-check form-check-single form-switch form-label">
                                    <input class="form-check-input form-control" type="checkbox" role="switch" id="flexSwitchCheckDefault" name="recommend">
                                  </label>
                                </span>
                              </label>
                            </div>
                            ...
                            <div class="col-md-12">
                              <label class="form-control form-label">
                                ...
                                <span class="col-auto">
                                  <label class="form-check form-check-single form-switch form-label">
                                    <input class="form-check-input form-control" type="checkbox" role="switch" id="flexSwitchCheckDefault" name="subscription_opened">
                                  </label>
                                </span>
                              </label>
                            </div>
              ...
              <div class="mb-3 ">
                ...
                <label for="plan_file" class="form-label">{{ __('admin.courses.plan_file') }}</label>
              ...
              <div class="mb-3 ">
                ...
                <label for="logo" class="form-label">{{ __('admin.courses.image') }}</label>
              ...
              <div class="mb-3 ">
                ...
                <label for="logo" class="form-label">{{ __('admin.courses.background_image') }}</label>
                        ...
                        <tr>
                          <td>
                            <select class=" form-control" name="instructors[]" style="padding:3px;">
                              ...
                              <option value="{{$instructor->id}}"> {{ $instructor->name }} - {{ $instructor->customPhone }}</option>
                              @endif
                              @endforeach
                            </select>
                          </td>
...
<script>
  ...
  //         var newRow = row.insertCell(i);
  //         newRow.innerHTML = table.rows[0].cells[i].innerHTML;
  //         var input = newRow.querySelector('input, select');
  //         if (input) {
  //             input.value = "0"; // Default empty value
