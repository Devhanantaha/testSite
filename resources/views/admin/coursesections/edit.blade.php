...
<div class="page-header d-print-none">
  <div class="container-xl">
    <div class="row g-2 align-items-center">
      <div class="col">
        {{ Breadcrumbs::render('update-course-sections',$row) }}
          ...
          <div class="card-body">
            ...
            <fieldset class="row scheduler-border">
              ...
              <div class="form-group col-md-12">
                <label class="form-label" for="name"> {{__('admin.coursesections.name')}} <span>*</span></label>
              ...
              <div class="form-group col-md-12">
                <label class="form-label" for="active" class="form-label">{{ __('admin.coursesections.status') }}</label>
                <div>
