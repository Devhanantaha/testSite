                ...
                <tr>
                  ...
                  <td>
                    ...
                    >
                      ...
                      <input data-id="{{$row->id}}" data-type='App\Models\Banner' class="form-check-input form-control toggole-class" type="checkbox"  role="switch" id="flexSwitchCheckDefault" @if($row->active==1) checked="checked" @endif name="active">
                    </div>
                  </td>
                  <td>
