<section class="section novi-bg novi-bg-img section-xl bg-default">
        <div class="section-xl bg-accent text-center">
          <div class="container">
            <div class="row justify-content-md-center row-50">
              <div class="col-md-6 col-lg-3">
                ...
                <article class="box-counter">
                  ...
                  <div class="box-counter__wrap">
                    <div class="counter animated-first">1000</div>
                  </div>
                  <p class="box-counter__title">Coffee Cups</p>
                </article>
              </div>
              <div class="col-md-6 col-lg-3">
                <!-- Box counter-->
                <article class="box-counter">
                  ...
                  <div class="box-counter__wrap">
                    <div class="counter animated-first">74</div>
                  </div>
              ...
              <div class="col-md-6 col-lg-3">
                ...
                <article class="box-counter">
                  ...
                  <div class="box-counter__wrap">
                    <div class="counter animated-first">5</div><span>bln+</span>
                  </div>
                  <p class="box-counter__title">of Clean Code Written</p>
                </article>
              </div>
              <div class="col-md-6 col-lg-3">
                <!-- Box counter-->
                <article class="box-counter">
                  ...
                  <div class="box-counter__wrap">
                    <div class="counter animated-first">147</div>
                  </div>
