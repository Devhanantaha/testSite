...
<input type="search" autocomplete="off" id="woocommerce-product-search-field-0F56f" class="search-field" placeholder="ابحث عن منتج&hellip;" 
...
<div class="mobile-menu-container">
    <ul id="menu-main-menu" class="nav-menu mobile-menu">
        <li class="menu-item menu-item-type-custom menu-item-object-custom current-menu-item current_page_item menu-item-home current-menu-ancestor  menu-item-6939 active">
            <a href="/ar" aria-current="page">الرئيسية</a>

</li>

<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-5355 dropdown"><a href="#/">المنتجات</a>
    <ul class="sub-menu">
...
@foreach($cat->items as $category)
        <li class="menu-item menu-item-type-custom menu-item-object-custom @if ($category->items->count() > 0) menu-item-has-children dropdown @endif menu-item-5934 ">
			<a href="{{ route('category.show2', $category->slug) }}/ar">{{$category->name2}}</a>
			@if ($category->items->count() > 0)
			<ul class="sub-menu">					
				@foreach($category->items as $item)
				<li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-5938">
					<a href="{{ route('category.show2', $item->slug) }}/ar">{{$item->name2}}</a></li>
				@endforeach
			</ul>
		@endif
        </li>
...
<li class="menu-item menu-item-type-post_type menu-item-object-page  menu-item-5353 dropdown"><a href="#/blog/">فالكون</a>
	<ul class="sub-menu">
	@foreach($top_menu as $page)
	<li class="menu-item menu-item-type-post_type menu-item-object-page "><a href="{{ route('page.show' , $page->slug)}}/ar">{{$page->name2}}</a></li>
	@endforeach
	<li class="menu-item menu-item-type-post_type menu-item-object-page "><a href="/media/ar">الوسائط</a></li>
	<li class="menu-item menu-item-type-post_type menu-item-object-page "><a href="/blog/ar">المقالات والاخبار</a></li>
	<li class="menu-item menu-item-type-post_type menu-item-object-page "><a href="/catalogs/ar">كتالوجات</a></li>
	<li class="menu-item menu-item-type-post_type menu-item-object-page "><a href="/contact/ar">اتصل بنا</a></li>
	</ul>
</li>
...
<a href="/login" title="">دخول / انشاء حساب<i class="fa fa-user-o"></i></a>
</div>	
<div class="wishlist-link">
<a href="/wishlist/ar">
المفضلة<i class="fa fa-heart-o"></i>
</a>
</div>		
</div>
...
<div class="cart-widget-content"><div class="widget woocommerce widget_shopping_cart">
    <h2 class="widgettitle"><span>سلة المشتريات</span><a href="javascript:void(0)" class="toggle-cartside"><i class="fa fa-times"></i></a></h2>
    <div class="widget_shopping_cart_content">
		...
		<div class="minicart-bottom">
				<p class="woocommerce-mini-cart__total total"><strong>اجمالى:</strong>
					 <span class="woocommerce-Price-amount amount"><bdi>
						 <span class="woocommerce-Price-currencySymbol">{{$currencysymbol}}</span>{{$cart_total}}</bdi></span></p>
						
				
				<p class="woocommerce-mini-cart__buttons buttons"><a href="/cart/ar" class="button wc-forward">عرض السلة</a>
					<a href="/checkout/ar" class="button checkout wc-forward">شراء</a></p>
			</div>
        </div>
