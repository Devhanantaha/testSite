            ...
            <div class="row flex-row-reverse">
                <div class="col-sm-3">
                                ...
                                <label class="form-control form-control-sm option" style="width:180px;" name="{{ strtolower($attribute->name ) }}"></label>
                                    ...
                                    @foreach($attribute->values as $attributeValue)
										...
										<div class="form-check">
											  <input class="form-check-input common_selector {{ $attribute->code }}"  type="checkbox" value="{{$attributeValue->value}}"  id="flexCheckDefault">
                    ...
                    @endforeach
							...
							<dd>
							<b  style="font-weight:bold;color:#fff">Price</b><br>
						 <input type="hidden" id="hidden_minimum_price" value="" />
						<input type="hidden" id="hidden_maximum_price" value="" />
						<label id="price_show" class="filter containerr" style="margin-bottom: 10px;">5995 - 29800</label>
...
$(document).ready(function(){
	...
	url:"{{url("fetch_data")}}/{{ $category->slug }}",
            ...
            data:{action:action,minimum_price:minimum_price,maximum_price:maximum_price,@foreach( $category->attributes as $attribute) {{$attribute->code}}:{{$attribute->code}}, @endforeach },
