@extends('site.app')
@section('title', 'Technical files')
@section('content')
<section class="section novi-bg novi-bg-img breadcrumbs-custom">
      <div class="container">
        <div class="breadcrumbs-custom__inner">
          <p class="breadcrumbs-custom__title">Technical files</p>
          <ul class="breadcrumbs-custom__path">
            <li><a href="/en">Home</a></li>
            <li class="active">Technical files</li>
          </ul>
        </div>
      </div>
    </section>
         ...
         <div class="row row-50">
           ...
           <div class="col-md-2">
             <div style="float:right;margin-top: 65px;font-size: 11px;font-weight: bold;color: #231f20;">
                <a style="color:black" class="icon icon-md linear-icon-download2 link-gray-4" href="{{ asset('storage/'.$article->file) }}"></a>
              </div>
           </div>
