		...
		<div class="product product-grid">
		  ...
		  <div class="product-caption">
		   ...
		   <p class="product-price sale-price"><span>{{$product->price}}</span><span>{{$product->sale_price}}</span>
			...
			<span class="icon novi-icon icon-md linear-icon-cart"></span><span>أصف للسلة</span></a>
			@else	
			<a class="button-gray-light-outline button button-icon button-icon-left" href="/product/{{$product->slug}}/ar">
			<span class="icon novi-icon icon-md linear-icon-magic-wand"></span><span>أختر</span></a>
