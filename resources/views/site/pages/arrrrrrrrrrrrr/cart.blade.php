...
<section class="section novi-bg novi-bg-img breadcrumbs-custom">
      <div class="container">
        <div class="breadcrumbs-custom__inner">
          <p class="breadcrumbs-custom__title">السلة</p>
   ...
   <form class="woocommerce-cart-form" action="/cart/update/m" method="get">
                  ...
                  <tr>
                   ...
                   <td style="min-width: 330px">
                     <div class="unit flex-row unit-spacing-md align-items-center">
                        <a class="thumbnail-classic-title" href="/product/{{$item->associatedModel->slug}}/ar">
                       <div class="unit-left">
                          <img src="{{ asset('storage/'.$item->associatedModel['images']->first()['thumbnail']) }}" alt="{{ $item->name }}" width="141" height="188">
                       </div>
                       </a><div class="unit-body"><a class="thumbnail-classic-title" href="/product/{{$item->associatedModel->slug}}/ar">
                         <h6>EM300E</h6>
                  </a>
                       </div>
          ...
          <div class="row row-50 text-center">
            <div class="col-md-8 text-md-left">
               <div class="group-xs">
               <a href="/shop/ar" class="button button-white">اكمل التسوق  </a>
               </div>
            </div>
            <div class="col-md-4 text-md-right">
               <input type="submit" class="button button-primary" value="تحديث السلة"></input>
            </div>
            <div class="col-sm-12">
                  <hr>
                </div>
                <div class="col-sm-12">
                     <div class="text-md-end">
                       ...
                       </dl><a class="button button-primary" href="/checkout/ar"> اشترى الان</a>
                     </div>
                   </div>
           </div>
         </form>
         @else
         <h3 class="text-center "> سلة فارغة</h3>
         @endif
         </div>
       </section>
