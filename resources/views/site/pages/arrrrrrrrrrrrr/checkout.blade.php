...
<section class="section novi-bg novi-bg-img breadcrumbs-custom">
      <div class="container">
        <div class="breadcrumbs-custom__inner">
          <p class="breadcrumbs-custom__title">شراء</p>
          <ul class="breadcrumbs-custom__path">
            <li><a href="/ar">الرئيسية</a></li>
            <li><a href="/cart/ar">السلة</a></li>
            <li class="active">شراء</li>
          </ul>
        </div>
      </div>
    </section>
             ...
             <div class="col-md-6 col-lg-8">
              ...
              <section class="w-100">
                     <div class="payment-box">
                       <div class="form-wrap">
                         <label class="radio-inline">
                           <input type="radio"  name="payment_method" value="Cash On Delevery" class="mr-2" >دفع عند الاستلام
                         </label>
                       </div>
                     ...
                     <div class="payment-box">
                       <div class="form-wrap">
                         <label class="radio-inline">
                           <input type="radio"  id="payment_method_paypal" class="input-radio mr-2" name="payment_method" value="paypal" >بطاقة ائتمانية
                         </label>
                       </div>
                       <div class="payment-box-inner">
                         <p> ادفع ببطاقة ائتمانية</p>
                       </div>
                     </div>
                     <div class="payment-box-button">
                       <button class="button button-primary"   id="place_order" type="submit">اكمل الطلب</button>
                     </div>
                 </section>
...
<script>
    function myFunction() {
        if (document.getElementById("payment_method_paypal").checked){
            document.getElementById("place_order").innerHTML = "اكمل ببطاقة ائتمانية";
        } else {
            
				$('#place_order').show();
            document.getElementById("place_order").innerHTML = "اكمل الطلب
        }
    }
    </script>
