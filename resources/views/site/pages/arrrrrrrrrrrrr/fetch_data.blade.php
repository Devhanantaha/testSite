        ...
        <div class=" col-6 col-md-3" style="padding-right:0px">
             <div class=" product-grid ">
                 <div class="product-img-wrap">
                     <a href="/product/{{$product->slug}}/ar">
          ...
          <div class=" col-6 col-md-9">
                 <div class="product-caption">
                     <a href="/product/{{$product->slug}}/ar">
                       <h6 class="product-title" style="margin-top: 8px;font-weight: bold;color:#9fa5aa;line-height:.5">{{ $product->name2 }}</h6>
                       <p style="color:#9fa5aa;font-size:13px" class="product-title">{{$product->categories[0]->name2}}<br> {{ strip_tags(str_limit($product->description2,250))}}<br></p><p>السعر: L.E {{$product->price}}</p>
                     </a><br>
                     @if(!$product->attribs )
                     <a href="#c" style=" font-size: small; " data-product_id ="{{$product->id}}" data-quantity ="1" class="font-italic add_to_cart"> 
                     <i class="icon icon-md linear-icon-cart link-gray-4"></i> اضف للسلة</a>
                     @else
                     
                     <a href="/product/{{$product->slug}}/ar" style=" font-size: small; " class="font-italic "> 
                            <i class="icon icon-md linear-icon-eye link-gray-4"></i> اختيار </a>
                    @endif
                 </div>
         </div>	
     </div>
