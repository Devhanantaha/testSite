@extends('site.appar')
@section('title', 'الكتالوجات')
@section('content')
<section class="section novi-bg novi-bg-img breadcrumbs-custom">
      <div class="container">
        <div class="breadcrumbs-custom__inner">
          <p class="breadcrumbs-custom__title">الكتالوجات</p>
          <ul class="breadcrumbs-custom__path">
            <li><a href="/ar">الرئيسية</a></li>
            <li class="active">الكتالوجات</li>
          </ul>
        </div>
      </div>
    </section>
    <section class="bg-default section-lg">
            <div class="container">
             <div class="row row-50">
               ...
               <div class="col-md-6">
                 <h6 class="font-bold">{{ $catalog->name2 }}</h6>
                 <p class="mt-0" style="font-size: 13px;color: #231f20;;line-height: 1.5">
                    {!!  strip_tags(str_limit($catalog->content2,250))!!}
                </p>
               </div>
               <div class="col-md-2">
