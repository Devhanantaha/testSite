@extends('site.appar')
@section('title', 'المقالات والاخبار')
@section('content')
<div id="content" class="site-content"><div class="page-banner blog-banner has-banner" style="min-height: 600px;">
<div class="page-banner-content">
<h1 class="entry-title">المقالات والاخبار</h1><div class="breadcrumbs circle-style" itemprop="breadcrumb"><a href="/ar">الرئيسية</a><span>المقالات والاخبار</span></div></div></div>
...
<a href="/blog-post/{{$blog->slug}}/ar" rel="bookmark">{{$blog->name2}}</a>
</h2>
</header>
...
<div class="elementor-text-editor elementor-clearfix"><p>{!! strip_tags(str_limit($blog->content2,250))!!}</p></div>
</div>
</div>
...
<li class="post-date"> <a href="/blog-post/{{$blog->slug}}/ar">{{$blog->created_at->format('d/M/Y')}}</a></li>
