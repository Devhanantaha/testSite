...
@section('content')
      <div id="content" class="site-content">
            ...
            <div class="container default-entry-header"><h1 class="entry-title simple-title">Request For Quotation</h1>
               <div class="breadcrumbs circle-style" itemprop="breadcrumb">
               <a href="/">Home</a><span> Request For Quotation</span></div>
            <!-- .container -->
            <div class="container">
               <div class="row">
                                 ...
                                 @if(\Session::has('error'))
                                          ...
                                          <div class="col-xl-8 col-lg-12 col-md-12 col-12">
												   ...
												   @foreach($rfq_content as $item)
                                                      <tr class="woocommerce-cart-form__cart-item cart_item">
                                                         ...
                                                         <td class="product-name" data-title="Product">
                                                               ...
                                                               <a href="/product/{{$item->associatedModel->slug}}/en">{{$item->name}}</a>	
                                           ...
                                           @endif												
                                                         ...
                                                         <td class="product-quantity" data-title="Quantity">
                                                            <div class="quantity">
															   <label class="screen-reader-text" for="quantity_6033c1e18efd4"> quantity</label>
                                                               <input
                                                                  type="number"
                                                                  id="{{$item->id}}"
                                                               ...
                                                               <div class="coupon row">
                                                                     <div class="col-6 header rfq mr-5">
                                                                           <div class="search-switcher hidden-sm hidden-xs">
                                                                                 ...
                                                                                 <span class="search-opener"><i style="cursor:pointer" class="single_add_to_cart_button button">Add Products</i></span>
                                                                  ...
                                                                  <div class="search-content-popup">
                                                                     ...
                                                                     <h3>Searching</h3>
                                                                        ...
                                                                        <ul class="items-list">
                                                                           ...
                                                                           @foreach($cats as $cat)
                                                                           @if(!$loop->first)
                                                                                       <li class="cat-item"><a data-slug="{{ $cat->slug }}" href="javascript:void(0)">{{ $cat->name }}</a></li>
                                                                                       @endif
                                                                                       @endforeach
                                                                                    </ul>
                                                                     </div>
                                                ...
                                                <button type="submit" class="button" name="update_cart" value="Update cart">Update </button>
                                                               </div>
									   ...
									   @if($rfq_content->count() > 0)
                                                   <div class="wc-proceed-to-checkout mt-5">
                                                      <a href="/rfq/details/en" class="checkout-button button alt wc-forward">
                                                     Continue to Contact Details</a>
                                                   </div>
										  @endif
                                                </div>
                                             </div>
                                          ...
                                          @else
                                          <h3 class="text-center"> RFQ Empty</h3>
                                    ...
                                    <h3>Searching</h3>
                                       ...
                                       <ul class="items-list" id="rfqcats">
                                          <li class="cat-item selected">
                                             <a href="javascript:void(0)" data-slug="">All categories</a></li>
                                          @foreach($cats as $cat)
                                          @if(!$loop->first)
                                                      <li class="cat-item"><a data-slug="{{ $cat->slug }}" href="javascript:void(0)">{{ $cat->name }}</a></li>
                                                      @endif
