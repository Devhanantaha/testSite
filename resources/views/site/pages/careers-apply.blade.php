...
<section class="section novi-bg novi-bg-img breadcrumbs-custom">
      <div class="container">
        <div class="breadcrumbs-custom__inner">
          <p class="breadcrumbs-custom__title">{{ $career->name }}</p>
          <ul class="breadcrumbs-custom__path">
            <li><a href="/en">Home</a></li>
            <li><a href="/careers/en">Careers</a></li>
            <li class="active">Apply to {{ $career->name }}</li>
          </ul>
        </div>
      </div>
    </section>
...
@include('site.partials.flash')
          <h3><span style="color:#231f2080">Apply to</span> {{ $career->name }}</h3>
