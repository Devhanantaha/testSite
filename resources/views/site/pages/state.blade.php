...
<section id="page-title" >
  ...
  <h1>{{ $state->LocalName }}</h1>
  <ol class="breadcrumb">
  <li class="breadcrumb-item"><a href="{{{ url('/') }}}"> {{__('site.home') }} </a></li>
  <li class="breadcrumb-item"><a href="{{ url('/where-we-work"') }}"> {{__('site.where') }}</a></li>
...
<ul class="tab-nav clearfix ui-tabs-nav ui-corner-all ui-helper-reset ui-helper-clearfix ui-widget-header" role="tablist">
  <li role="tab" tabindex="0" class="ui-tabs-tab ui-corner-top ui-state-default ui-tab ui-tabs-active ui-state-active" aria-controls="tab-responsive-1" aria-labelledby="ui-id-34" aria-selected="true" aria-expanded="true"><a href="#tab-responsive-1" tabindex="0" class="ui-tabs-anchor" id="ui-id-33">{{__('site.overview') }}</a></li>
<li role="tab" tabindex="0" class="ui-tabs-tab ui-corner-top ui-state-default ui-tab " aria-controls="tab-responsive-2" aria-labelledby="ui-id-34" aria-selected="false" aria-expanded="false"><a href="#tab-responsive-2" tabindex="-1" class="ui-tabs-anchor" id="ui-id-34"> {{__('site.stories') }} </a></li>
<li role="tab" tabindex="-1" class="ui-tabs-tab ui-corner-top ui-state-default ui-tab" aria-controls="tab-responsive-3" aria-labelledby="ui-id-35" aria-selected="false" aria-expanded="false"><a href="#tab-responsive-3" tabindex="-1" class="ui-tabs-anchor" id="ui-id-35">{{__('site.voices') }} </a></li>
<li class="d-none d-md-block ui-tabs-tab ui-corner-top ui-state-default ui-tab" role="tab" tabindex="-1" aria-controls="tab-responsive-4" aria-labelledby="ui-id-36" aria-selected="false" aria-expanded="false"><a href="#tab-responsive-4" tabindex="-1" class="ui-tabs-anchor" id="ui-id-36">{{__('site.gallery') }} </a></li>
</ul>
  ...
  <div class="row">
    ...
    <div class="col-md-2">
       ...
       <div class="col-md-10">
         ...
         <a href="{{ route('page.show' , $story->slug) }}/{{ $local }}" class="button button-border button-dark button-rounded text-uppercase m-0">{{__('site.readmore') }}</a>
       </div>
    @endforeach
  </div>
</div>
