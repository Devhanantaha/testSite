...
<div class="card">
    <div class="card-body text-center">
        ...
        <h3 class="mb-4">{{ __('auth_register') }}</h3>

        <!-- Form Start -->
        <form method="POST" action="{{ route('register') }}">
        @csrf
            <div class="input-group mb-3">
                <input id="first_name" type="text" class="form-control @error('first_name') is-invalid @enderror" name="first_name" value="{{ old('first_name') }}" required autocomplete="first_name" placeholder="{{ __('field_first') }} {{ __('field_name') }}" autofocus>
            ...
            <div class="input-group mb-3">
                <input id="last_name" type="text" class="form-control @error('last_name') is-invalid @enderror" name="last_name" value="{{ old('last_name') }}" required autocomplete="last_name" placeholder="{{ __('field_last') }} {{ __('field_name') }}" autofocus>
