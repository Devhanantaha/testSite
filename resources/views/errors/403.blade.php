...
<body class="bg-dark text-white py-5">
    <div class="container py-5">
        ...
        <div class="row">
            <div class="col-md-2 text-center">
                <p><i class="fa fa-exclamation-triangle fa-5x"></i><br />الكود : 403</p>
            </div>
            <div class="col-md-10">
                <h3>نعتذر!!!! ...</h3>
                <p>عذرًا، تم رفض وصولك ليس لك صلاحية  تتعلق بهذا الرابط .
                    <br />يُرجى العودة إلى الصفحة السابقة لمواصلة التصفح.</p>
